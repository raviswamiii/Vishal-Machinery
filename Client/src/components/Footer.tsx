...
export const Footer = () => {
  return (
    <div className="bg-black min-h-screen p-4 text-white">
      <div className="flex flex-col gap-6 border-b-[0.5px] border-gray-300/50 py-6">
        <div className="flex items-center gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Talk to our experts today.</p>
          </div>
        </div>

        <button className="bg-yellow-400 flex items-center justify-center text-black text-sm font-bold py-4 rounded-lg montserrat">
          CONTACT US
      ...
      <div className="flex items-center text-xs gap-1 text-gray-500 justify-center ">
        <MdOutlineCopyright />
