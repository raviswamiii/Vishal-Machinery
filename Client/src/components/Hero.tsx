...
export const Hero = () => {
  return (
    <div className="h-[calc(100vh-60px)] max-h-187.5 flex flex-col">
      <div className="flex flex-col justify-center overflow-hidden">
        <div className="border border-red-500 flex-1 absolute z-10 w-[50%] sm:w-[45%] lg:w-[40%] text-white pl-[4vw] sm:pl-[8vw] flex flex-col justify-center gap-[2vh]">
          <div className="flex flex-col gap-[1vh]">
            ...
            <h1 className="text-[7vh] sm:text-[8vh] md:text-[9vh] lg:text-[10vh] font-semibold bebas-neue leading-none">
              BUILD FOR <br />{" "}
        ...
        <div className="border-5 border-amber-500 h-[calc(100vh-140px)] overflow-hidden relative">
          <img
...
{
  /* <div className="h-[calc(100vh-60px)] max-h-187.5 bg-black">
